...
public final class DigitalWatchFaceUtil {
    ...
    /**
     * The {@link DataMap} key for {@link android.support.wearable.watchface.WatchFaceService} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link DataMap} key for {@link android.support.wearable.watchface.WatchFaceService} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link DataMap} key for {@link android.support.wearable.watchface.WatchFaceService} minute digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link DataMap} key for {@link android.support.wearable.watchface.WatchFaceService} second digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_SECONDS_COLOR = "SECONDS_COLOR";

    public static final String KEY_BALANCE_COLOR = "BALANCE_COLOR";

    /**
     * The path for the {@link DataItem} containing {@link android.support.wearable.watchface.WatchFaceService} configuration.
     */
    ...
    /**
     * Name of the default interactive mode balance digits color and the ambient mode balance digits
     * color.
     */
    public static final String COLOR_NAME_DEFAULT_AND_AMBIENT_BALANCE_DIGITS = "White";
    public static final int COLOR_VALUE_DEFAULT_AND_AMBIENT_BALANCE_DIGITS =
            parseColor(COLOR_NAME_DEFAULT_AND_AMBIENT_BALANCE_DIGITS);
    /**
     * Callback interface to perform an action with the current config {@link DataMap} for
     * {@link android.support.wearable.watchface.WatchFaceService}.
     */
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link android.support.wearable.watchface.WatchFaceService}
