...
import com.aegiswallet.utils.DigitalWatchFaceUtil;
...
public class WatchFaceService extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        int mInteractiveBalanceDigitsColor = DigitalWatchFaceUtil.COLOR_VALUE_DEFAULT_AND_AMBIENT_BALANCE_DIGITS;
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mBackgroundPaint.setColor(resources.getColor(R.color.aegis_blue));
            mHourPaint = createTextPaint(mInteractiveHourDigitsColor);
            mMinutePaint = createTextPaint(mInteractiveMinuteDigitsColor);
            mBalancePaint = createTextPaint(mInteractiveMinuteDigitsColor);
            ...
            Drawable backgroundDrawable = resources.getDrawable(R.drawable.btcwhite);
        ...
        public void onAmbientModeChanged(boolean inAmbientMode) {
            ...
            adjustPaintColorToCurrentMode(mBalancePaint, mInteractiveMinuteDigitsColor,
                    DigitalWatchFaceUtil.COLOR_VALUE_DEFAULT_AND_AMBIENT_BALANCE_DIGITS);
            ...
            if (mLowBitAmbient) {
                ...
                mBalancePaint.setAntiAlias(antiAlias);
        ...
        private void setInteractiveBackgroundColor(int color) {
            ...
            updatePaintIfInteractive(mBackgroundPaint, getResources().getColor(R.color.aegis_blue));
        }
        ...
        private void setInteractiveBalanceDigitsColor(int color) {
            mInteractiveBalanceDigitsColor = color;
            updatePaintIfInteractive(mBalancePaint, color);
        }
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            // Draw the bitcoin bitmap
            Paint p = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            canvas.drawBitmap(mBackgroundScaledBitmap,  (bounds.width()/2) - 25, (bounds.height()/2) - 33, p);
            ...
            // Draw the hours.
            float x = (width / 2) - (mHourPaint.measureText(hourString + COLON_STRING + minuteString) / 2);
            ...
            String balance = prefs.getString("BALANCE", "N/A");

            mBalancePaint = createTextPaint(mInteractiveHourDigitsColor);
            float balanceSize = resources.getDimension(isRound
                    ? R.dimen.digital_am_pm_size_round : R.dimen.digital_am_pm_size);
            mBalancePaint.setTextSize(balanceSize);

            float balanceWidth = mBalancePaint.measureText(balance);
            canvas.drawText(balance, (width/2) - (balanceWidth/2), 240, mBalancePaint);
        }
        ...
        private void setDefaultValuesForMissingConfigKeys(DataMap config) {
            ...
            addIntKeyIfMissing(config, DigitalWatchFaceUtil.KEY_BALANCE_COLOR,
                    DigitalWatchFaceUtil.COLOR_VALUE_DEFAULT_AND_AMBIENT_BALANCE_DIGITS);
        }
        ...
        private boolean updateUiForKey(String configKey, int color) {
            ...
            else if(configKey.equals(DigitalWatchFaceUtil.KEY_BALANCE_COLOR)){
                setInteractiveBalanceDigitsColor(color);
            } else {
